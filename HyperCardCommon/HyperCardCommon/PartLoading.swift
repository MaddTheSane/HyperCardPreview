...
private extension DataRange {
    ...
    func readPartStyle(at offset: Int) -> PartStyle {
        ...
        let styleIndex: UInt8 = self.readUInt8(at: offset)
        switch styleIndex {
        case 0:
    ...
    func readTextAlign(at offset: Int) -> TextAlign {
        ...
        let textAlignIndex: Int16 = self.readSInt16(at: offset)
